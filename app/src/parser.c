...
parser_error_t parser_getItemWithdrawTokens(const parser_context_t *ctx,
                                       uint16_t displayIdx,
                                       char *outKey, uint16_t outKeyLen,
                                       char *outVal, uint16_t outValLen,
                                       uint8_t pageIdx, uint8_t *pageCount) {
...
parser_error_t parser_getItemDepositTokens(const parser_context_t *ctx,
                                       uint16_t displayIdx,
                                       char *outKey, uint16_t outKeyLen,
                                       char *outVal, uint16_t outValLen,
                                       uint8_t pageIdx, uint8_t *pageCount) {
    ...
    *pageCount = 1;
    ...
    switch (parser_tx_obj.script.type) {
        ...
        case script_th01_withdraw_unlocked_tokens:
            return parser_getItemWithdrawTokens(ctx, displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx,
                                                pageCount);
        case script_th02_deposit_unlocked_tokens:
            return parser_getItemDepositTokens(ctx, displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx,
                                               pageCount);
    }
