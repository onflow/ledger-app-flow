...
parser_error_t _matchScriptType(uint8_t scriptHash[32], script_type_e *scriptType) {
    *scriptType = SCRIPT_UNKNOWN;
    ...
    const struct known_script_entry KNOWN_TYPES[] = {
        ...
        {SCRIPT_SCO01_SETUP_STAKING_COLECTION, TEMPLATE_HASH_SCO01_SETUP_STAKING_COLECTION_TESTNET},
        {SCRIPT_SCO01_SETUP_STAKING_COLECTION, TEMPLATE_HASH_SCO01_SETUP_STAKING_COLECTION_MAINNET},
