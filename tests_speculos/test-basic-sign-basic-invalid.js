...
common.compare(hexOutgoing, hexExpected, "apdu command", {cla:1, ins:1, p1:1, p2:1, len:1, message:8, unexpected:9999});
common.testStep(" >    ", "APDU out");
common.asyncCurlApduSend(hexOutgoing);
common.testStep("     <", "APDU in");
var hexResponse = await common.curlApduResponseWait();
var hexEXpected = "7061727365725f726c705f6572726f725f696e76616c69645f6b696e646984";
common.compare(hexResponse, hexEXpected, "apdu response", {signatureCompact:29, returnCode:2, unexpected:9999});
