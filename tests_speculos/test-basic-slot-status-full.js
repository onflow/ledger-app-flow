...
//assert.equal(slotStatusResponse.status, expectedBuffer);
...
const getSlotResponse = await app.getSlot(emptySlot);
assert.equal(getSlotResponse.returnCode, 0x6982);
assert.equal(getSlotResponse.errorMessage, "Empty Buffer");
...
const setSlotPromise2 = app.setSlot(10, expectedAccountDelete, expectedPathDelete);
common.testStep("   +  ", "buttons");
