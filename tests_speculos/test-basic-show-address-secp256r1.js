...
common.testStep(" - - -", "await app.setSlot() // fakeSlot=" + fakeSlot  + " fakeAddress=" + fakeAddress + " fakePath=" + fakePath);
...
common.testStep(" - - -", "await app.showAddressAndPubKey() // goodSlot=" + goodSlot);
