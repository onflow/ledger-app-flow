...
Download a release from here (https://github.com/Zondax/ledger-flow/releases). You only need `zxtool.sh`
...
> At this moment, if you change the app source code, you will need to run `make` before running the test again.

First, install and update JS dependencies.
