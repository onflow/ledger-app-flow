...
- Building the app itself
  ...
  However, you may want to clean up first (e.g. if you switched branches)
...
```
The 5002 test test sign transaction calls against some of the generated test vectors. The 5001 tests test other calls
