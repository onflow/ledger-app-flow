...
extern parser_error_t printGenericAppSpecific(const parser_context_t *ctx, const eth_tx_t *ethTxObj, uint8_t displayIdx,
                                              char *outKey, uint16_t outKeyLen, char *outVal, uint16_t outValLen,
                                              uint8_t pageIdx, uint8_t *pageCount);
extern parser_error_t printERC20TransferAppSpecific(const parser_context_t *ctx, const eth_tx_t *ethTxObj,
...
static parser_error_t printERC20Transfer(const parser_context_t *ctx, uint8_t displayIdx, char *outKey,
    ...
    *pageCount = 1;
    ...
    return printERC20TransferAppSpecific(ctx, &eth_tx_obj, displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx,
                                         pageCount);
}
...
static parser_error_t printGeneric(const parser_context_t *ctx, uint8_t displayIdx, char *outKey, uint16_t outKeyLen,
    ...
    *pageCount = 1;
    ...
    return printGenericAppSpecific(ctx, &eth_tx_obj, displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx,
                                   pageCount);
}
...
parser_error_t _getNumItemsEth(uint8_t *numItems) { return getNumItemsEthAppSpecific(&eth_tx_obj, numItems); }
